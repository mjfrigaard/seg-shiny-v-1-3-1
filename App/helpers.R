...
# 0.0.1 - root github repo  ---- ---- 
github_root  <- "https://raw.githubusercontent.com/"

# 0.0.2 - root github data repo ---- ---- 
github_data_root <- base::paste0(github_root, 
                           "mjfrigaard/seg-shiny-data/master/Data/")
# 0.0.3 - root github image repo ---- ---- 
github_image_root <- base::paste0(github_root, 
                            "mjfrigaard/seg-shiny-data/master/Image/")

# 0.0.4 - the VanderbiltComplete file ---- ---- 
full_sample_repo <- base::paste0(github_data_root, 
                                 "VanderbiltComplete.csv")

# 0.0.5 - the AppRiskPairData file  ---- ---- 
app_riskpair_repo <- base::paste0(github_data_root, 
                                  "AppRiskPairData.csv")

# 0.0.6 - the AppLookUpRiskCat file  ---- ---- 
app_lookup_repo <- base::paste0(github_data_root, 
                                "AppLookUpRiskCat.csv")

# 0.0.7 - the APPSEGBlandAltmanRefVals file  ---- ---- 
ba_ref_repo <- base::paste0(github_data_root, 
                           "APPSEGBlandAltmanRefVals.csv")

# 0.0.8 - load RiskPairData ----
RiskPairData <- read_csv(paste0(github_root, app_riskpair_repo))

# 0.0.9 - LookUpRiskCat ----
LookUpRiskCat <- read_csv(paste0(github_root, app_lookup_repo))

# 0.1.0 - SEGBlandAltmanRefVals -----
SEGBlandAltmanRefVals <- read_csv(paste0(github_root, ba_ref_repo))

# 0.1.1 define risk grade look-up table lkpRiskGrade  ---- ---- ----
# for RiskGradeTable3
...
# 0.1.3 define lkpISORanges look-up table for ISORangeTable5  ---- ---- ----
...
# 1.0.6 create base_data data frame ---- ----- 
